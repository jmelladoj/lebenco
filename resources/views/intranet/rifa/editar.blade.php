@section('title', 'LEBENCO - Editar Rifa')

@section('seccion', 'Editar Rifa')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Editar Rifa</h4>
                </div>
                <div class="card-body">
                    <form class="form" method="post" action="{{ url('/rifas/'. $raffle->id .'/editar') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="form-group m-t-40 row">
                                <label for="titulo" class="col-2 col-form-label">Título *</label>
                                <div class="col-4">
                                    <input type="text" id="titulo" name="titulo" class="form-control" required="" value="{{ old('titulo',  $raffle->titulo) }}">
                                </div>

                                <label for="valor" class="col-2 col-form-label">Valor *</label>
                                <div class="col-4">
                                    <input type="number" id="valor" name="valor" class="form-control" required="" min="0" value="{{ old('valor',  $raffle->valor_registro) }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group m-t-40 row">
                                ...
                                <div class="col-4">
                                    <input type="text" id="premio" name="premio" class="form-control" required="" value="{{ old('premio',  $raffle->premio) }}">
                                </div>

                                <label for="fecha_termino" class="col-2 col-form-label">Fecha termino*</label>
                                <div class="col-4">
                                    <input type="date" id="fecha_termino" name="fecha_termino" class="form-control" required="" value="{{ old('fecha_termino',  $raffle->fecha_termino) }}">
                                </div>
                            </div>
