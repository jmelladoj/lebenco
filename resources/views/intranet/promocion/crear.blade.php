@section('title', 'LEBENCO - Crear Promoción')

@section('seccion', 'Crear Promoción')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="m-b-0 text-white">Añadir Promoción</h4>
                </div>
                <div class="card-body">
                    <form class="form" method="post" action="{{ url('promociones') }}" accept-charset="UTF-8" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
