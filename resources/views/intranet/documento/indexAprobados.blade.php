@section('title', 'LEBENCO - Documentos Aprobados')

@section('seccion', 'Documentos Aprobados')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row"> 
                        <div class="col-lg-6">
                            <h4 class="card-title">Documentos Aprobados</h4>
                        </div>
                        <div class="col-lg-6">
    ...
    <script>
        $(document).ready(function() {
            $('#tablaDocumentosAprobados').DataTable({
                ...
                ajax: '{{ url('obtenerDocumentosAprobados') }}',
                columns:[
                            { data: 'id', name: 'id' },
